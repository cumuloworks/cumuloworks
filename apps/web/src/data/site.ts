...
export const socials: Social[] = [
  {
    id: 'x',
    name: 'X',
    url: 'https://x.com/cumuloworks',
    handle: '@cumuloworks',
  },
  {
    id: 'instagram',
    name: 'Instagram',
    url: 'https://www.instagram.com/cumuloworks/',
    handle: '@cumuloworks',
  },
  {
    id: 'youtube',
    name: 'YouTube',
    url: 'https://www.youtube.com/@cumuloworks',
    handle: '@cumuloworks',
  },
  {
    id: 'github',
    name: 'GitHub',
    url: 'https://github.com/cumuloworks',
    handle: '@cumuloworks',
  },
  {
    id: 'facebook',
    name: 'Facebook',
    url: 'https://www.facebook.com/cumuloworks/',
    handle: 'Cumuloworks',
  },
  {
    id: 'spotify',
...
export const studioReel = {
  ...
  eyebrow: {
    en: 'Showreel · kumo.productions™',
    ja: 'ショーリール · kumo.productions™',
  } as Bi,
};
...
export const talks: Talk[] = [
  {
    y: '2024',
    src: 'Vook',
    t: 'ストレージ容量の限界がクリエイティブを妨げる⁉',
    url: 'https://vook.vc/n/7699',
  },
  {
    y: '2024',
    src: 'VGT 2024',
    t: '「快適な制作環境の作り方」',
    url: 'http://cumulo.works/blogs/vgt2024',
  },
  {
    y: '2024',
    src: 'Vook',
    t: '「裏（バックエンド）を聞く」',
    url: 'https://vook.vc/n/7157',
  },
  {
    y: '2022',
    src: 'CGWORLD vol.290',
